...
keys = [
    ...
    Key(
        [mod, "mod1"], "Return", lazy.spawn(aterminal), desc="Launch alternate terminal"
    ),
    Key([mod], "d", lazy.spawn(dmenu), desc="Launch dmenu"),
    Key([mod, "mod1"], "e", lazy.spawn(afileman), desc="Launch alternate file manager"),
    Key([mod], "e", lazy.spawn(fileman), desc="Launch file manager"),
    Key([mod], "n", lazy.spawn(editor), desc="Launch my editor of choice"),
    Key([mod], "b", lazy.spawn(browser), desc="Launch chromium web browser"),
    Key([mod], "f", lazy.spawn(firefox), desc="Launch firefox web browser"),
    Key(
        [mod],
        "s",
        lazy.spawn("dex /usr/share/applications/spotify-adblock.desktop"),
        desc="Launch spotify",
    ),
